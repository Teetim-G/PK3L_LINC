...
String password_ = request.getParameter("pw_");
String nickname = request.getParameter("nick_");
String to = request.getParameter("email_");
...
String sSQL = "insert into user_stat(s_ID,s_Password,s_NickName,s_EMail,s_AccStat)values(?,md5(?),?,?,?);";
...
try{
	...
	sSQL = "insert into certification(s_UserID,n_key) values (?,?);"; 
	
	pstmt1=conn.prepareStatement(sSQL);
	pstmt1.setString(1, idial);
