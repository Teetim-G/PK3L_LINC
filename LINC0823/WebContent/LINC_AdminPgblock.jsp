					...
					<tbody>
						...
						<tr>
							<td><a href="javascript://"
								...
								<td><%=s_EMail%></td>
								<td><p
										style="overflow: hidden; text-overflow: ellipsis; white-space: nowrap; width: 200px;"><%=s_BlockDetail%></p></td>
					...
					<div class="btn-toolbar" role="toolbar"
						...
						<div class="btn-group mr-2" role="group" aria-label="First group">
							...
							for (int iCount = startPage; iCount <= endPage; iCount++) {
								if (iCount == Page) {
									out.print(" <b>&nbsp" + iCount + "&nbsp</b>");
								} else {

									out.println("<a href=\"?cnum=" + iCount + "\">&nbsp" + iCount + "&nbsp</a>");
