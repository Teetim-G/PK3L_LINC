  ...
  <div id="wrap">
    ...
    <div id="main">
        <div id="menu">
            ...
            <a class="list-group-item list-group-item-action active" data-toggle="list" onclick="location.href='LINC_BlogBoardTest2.jsp'">게시판2</a>
      ...
      <div id="conmain">
        <table class="table table-striped" style="width:1000px;">
          ...
          <%
            ...
            try{
              String sSQL = "SELECT * FROM linc_c.forum where n_ForumCategory='1'&&is_delete='0' order by n_PostOrder desc;";
              //asc = 오름차순 || desc = 내림차순
