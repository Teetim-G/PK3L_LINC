...
<body onload="classt()">
	...
	<div id="wrap">
		...
		<div id="main">
			...
			if (listnum != null) {
				session.setAttribute("blockEndlistnum", listnum);
			}
			%>
			<div id="contents">
			<form action="LINC_AdminPgblockEnd.jsp" method="GET"
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						int countList = 1;
						if (session.getAttribute("blockEndlistnum") != null) {
							countList = Integer.parseInt((String) session.getAttribute("blockEndlistnum"));
						}
						...
						<tr>
							<td><a href="javascript://"
								onclick="popupWindow('<%=s_ID%>');" style="color: blue;font-weight: 700;"><%=s_ID%></a></td>
							<td><%=s_NickName%></td>
							<td><%=s_EMail%></td>
							<td><%=n_BlockCount%></td>
