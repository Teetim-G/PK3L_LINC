...
<body onload="classt()">
	...
	<div id="wrap">
		...
		<div id="main">
			...
			if (listnum != null) {
				session.setAttribute("reportlistnum", listnum);
			}
			%>
			<div id="contents">
			<form action="LINC_AdminPgreport.jsp" method="GET"
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						int countList = 1;
						if (session.getAttribute("reportlistnum") != null) {
							countList = Integer.parseInt((String) session.getAttribute("reportlistnum"));
						}
