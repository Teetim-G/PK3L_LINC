               ...
               <form action="Access.jsp" method="post" name="login"id="login">
                  <div class="form-group">
                  	<table>
                  		...
                  		<tr>
                  			<td><input type="text" name="idial"id="idial"class="form-control" style="IME-MODE: disabled"maxlength="20"require>
                  		...
                  		<tr>
                  			<td><input type="password"name="password"id="password"class="form-control"maxlength="16"></td>
                  		</tr>
                  		<tr>
                  			<td><label for="cpassword">비밀번호 재 입력</label></td>
                  		</tr>
                  		<tr>
                  			<td><input type="password"name="cpassword"id="cpassword"class="form-control"maxlength="16"></td>
                  		</tr>
                  		<tr>
...
<script type="text/javascript" language="javascript">
	...
	$("#idVal").click(function(){
		...
		if(id_input.length>20 || id_input.length<5){
			alert("아이디는 5~20자리 입니다.");
			document.getElementById("id_check").value = 0
			return;
		}
		$.ajax({
