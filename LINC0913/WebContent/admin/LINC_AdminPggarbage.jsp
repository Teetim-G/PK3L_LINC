...
<body onload="classt()">
	...
	<div id="wrap">
		...
		<div id="main">
			...
			%>
			<div id="contents">
			<form action="LINC_AdminPggarbage.jsp" method="GET"
				...
				<table class="table table-striped">
					...
					<tbody>
						...
						Statement stmt = null;
						int usercount = 0;
						String sql2 = "SELECT COUNT(*) FROM forum where is_Delete='1'";
						...
						try {
							...
							tot = rs2.getInt(1);
							rs2.close();
							String sql = "select * from forum where is_Delete='1' order by n_PostOrder DESC LIMIT " + cstart + "," + countList;
						...
						<tr>
							...
							<td><a href="javascript://" onclick="popupWindow('<%=s_PostUser%>');" style="color: blue;font-weight: 700;"><%=s_PostUser%></a></td>
							...
							<td><form action="process/LINC_Updateforum.jsp" method="GET" name="Updateforum" style="height: 0px">
									<input name="n_PostOrder" type="hidden"
										...
										name="cnum" type="hidden" value="0">
									<%
										if (Integer.parseInt(is_Delete) == 0) {
									%><input type="button"
										value="삭제" onclick="submit()">
									<%
										} else {
