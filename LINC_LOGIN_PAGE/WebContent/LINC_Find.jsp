        ...
        <div class="col-lg-9 p-5 border">
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="list-profile" role="tabpanel" aria-labelledby="list-profile-list">
              ...
              <hr>
              <form action="Linc_FindID.jsp">
                <label for="InputNick">이메일 주소</label>
                <div class="form-group form-inline mb-2">
                  <input type="text" class="form-control mx-sm-3 mb-2" id="InputNick" placeholder="">
                  <button type="submit" class="btn btn-primary mb-2 form-control">인증번호 요청</button>
                </div>
                <label for="InputEmail">인증번호</label>
                <div class="form-group form-inline mb-2">
                  <input type="email" class="form-control mx-sm-3 mb-2" id="InputEmail" placeholder="">
                  <button type="submit" class="btn btn-primary mb-2 form-control">인증번호 확인</button>
                </div>
              </form>
            </div>
            ...
            <h5 class="pb-3">비밀번호 변경</h5>
              ...
              <form id="passform">
                ...
                <div class="form-group form-inline mb-2">
                  <input type="email" class="form-control mx-sm-3 mb-2" id="InputEmail" placeholder="">
                  <button type="submit" class="btn btn-primary mb-2 form-control">인증번호 전송</button>
                </div>
                <label for="InputEmail">인증번호</label>
                <div class="form-group form-inline mb-2">
                  <input type="email" class="form-control mx-sm-3 mb-2" id="InputEmail" placeholder="">
